                ...
                <div class="col-lg-9">
                    <div class="card-custom p-4 p-md-5">
                        <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                            <div class="bg-light-green text-dark-green rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                <i class="fa-solid fa-file-signature fs-4"></i>
                            </div>
                            <div>
                                <h4 class="fw-bold mb-0">SIWES Placement Preferences Application</h4>
                        ...
                        <form action="<?= $baseUrl ?>/index.php?route=student/application" method="POST">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <label for="preferred_industry" class="form-label fw-semibold">Preferred Industry Sector *</label>
                                ...
                                <div class="col-md-6">
                                    <label for="preferred_location" class="form-label fw-semibold">Preferred State / Location *</label>
                                ...
                                <div class="col-md-12">
                                    <label for="notes" class="form-label fw-semibold">Special Skills & Technical Focus Notes</label>
