                ...
                <div class="col-lg-9">
                    <div class="card-custom p-4 p-md-5">
                        <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
                            <div>
                                <h4 class="fw-bold mb-1 text-dark-green"><i class="fa-solid fa-diagram-project me-2"></i> Official Allocation Status</h4>
                                <p class="text-secondary fs-7 mb-0">SIWES Placement Details & Company Assignment Card</p>
                            </div>
                            <?php if ($allocation): ?>
                                <a href="<?= $baseUrl ?>/index.php?route=allocation-letter" class="btn btn-green fw-bold">
                            ...
                            <div class="p-4 bg-light rounded-4 mb-4 border">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <h4 class="fw-bold text-dark-green mb-1"><?= htmlspecialchars($allocation['company_name']) ?></h4>
                                    ...
                                    <div class="col-md-6 text-md-end">
                                        ...
                                        <span class="display-6 fw-extrabold text-primary-green"><?= $allocation['compatibility_score'] ?>%</span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="fw-semibold text-dark"><?= htmlspecialchars($allocation['company_address']) ?>, <?= htmlspecialchars($allocation['company_city']) ?>, <?= htmlspecialchars($allocation['company_state']) ?></div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="text-secondary fs-7 d-block">Company Supervisor / Contact</label>
                                        <div class="fw-semibold text-dark"><?= htmlspecialchars($allocation['contact_person']) ?></div>
                                        <div class="text-secondary fs-7"><i class="fa-solid fa-phone me-1"></i> <?= htmlspecialchars($allocation['company_phone']) ?></div>
                                        <div class="text-secondary fs-7"><i class="fa-solid fa-envelope me-1"></i> <?= htmlspecialchars($allocation['company_email']) ?></div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="text-secondary fs-7 d-block">Start Date</label>
                                        <div class="fw-semibold text-dark"><?= date('F d, Y', strtotime($allocation['start_date'])) ?></div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="text-secondary fs-7 d-block">End Date</label>
                                        <div class="fw-semibold text-dark"><?= date('F d, Y', strtotime($allocation['end_date'])) ?></div>
                                    </div>
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="text-center py-5">
                                ...
                                <p class="text-secondary max-w-500 mx-auto fs-7">
