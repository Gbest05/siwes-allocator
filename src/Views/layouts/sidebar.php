...
<aside class="app-sidebar">
    <div class="sidebar-brand d-flex align-items-center justify-content-between">
        <a href="<?= $baseUrl ?>/index.php?route=home" class="text-white text-decoration-none d-flex align-items-center gap-2">
            ...
            <?php else: ?>
                <i class="fa-solid fa-graduation-cap text-primary-green fs-4"></i>
            <?php endif; ?>
            <span class="text-truncate"><?= htmlspecialchars($siteSettings['site_name'] ?? 'SIWES Portal') ?></span>
        </a>
    </div>

    <div class="px-3 py-2 text-uppercase text-secondary fs-7 fw-bold" style="font-size: 0.75rem; letter-spacing: 0.08em;">
        Navigation Menu
    </div>
    ...
    <nav class="nav flex-column flex-grow-1">
        ...
        <?php elseif ($role === 'coordinator' || $role === 'admin'): ?>
            ...
            <?php if ($role === 'admin'): ?>
                <div class="px-3 py-2 text-uppercase text-secondary fs-7 fw-bold mt-3" style="font-size: 0.75rem; letter-spacing: 0.08em;">
                    Administration
                </div>
    ...
    <div class="p-3 border-top border-secondary border-opacity-25 mt-auto">
        <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center gap-2 overflow-hidden">
                <div class="rounded-circle bg-primary-green text-white d-flex align-items-center justify-content-center fw-bold" style="width: 38px; height: 38px; flex-shrink: 0;">
            ...
            <a href="<?= $baseUrl ?>/index.php?route=logout" class="text-secondary hover-white fs-5 ms-2" title="Logout">
